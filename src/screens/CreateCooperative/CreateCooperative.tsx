...
const steps = [
  { number: 1, title: "Basic Info", icon: Building2, description: "Organization details" },
  { number: 2, title: "Location", icon: MapPin, description: "Address information" },
  { number: 3, title: "Banking", icon: Landmark, description: "Bank & documents" },
];
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      toast.error("Error Creating Cooperative", {
        description: error.message || "Failed to save cooperative. Please try again.",
      });
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="max-w-4xl mx-auto">
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl>
                                <SelectTrigger className="border-gray-300 text-gray-900 h-11">
        ...
        <div className="mt-8 p-4 rounded-lg bg-gray-50 border border-gray-200">
          <p className="text-sm text-gray-600 text-center">
            ...
            <a href="mailto:support@cooperative.com" className="text-gray-900 hover:underline font-medium">
